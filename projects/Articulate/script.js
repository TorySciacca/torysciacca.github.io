...
function loadCategories(){
    for (let i = 0; i < totalCategories; i++) {
        ...
        document.getElementById(prompts[i]).innerText = i === totalCategories - 1 ? promptLibrary[prompts[Math.floor(Math.random() * (totalCategories - 1))]].splice(randomIndex, 1)[0] : selectedPrompt;
    } 
}
